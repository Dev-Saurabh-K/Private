...
const QuizSection = () => {
  ...
  return (
    <div className="flex flex-col border border-slate-300 md:p-5 p-2 gap-4 rounded-md">
        ...
        <div className="bg-slate-950 text-slate-50 font-semibold rounded-md py-2 px-3 w-fit h-fit cursor-pointer hover:bg-slate-800" onClick={()=>navigate("/quiz")}>Start Quiz</div>
    </div>
  )
}
